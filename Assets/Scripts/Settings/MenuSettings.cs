...
namespace LemApperson_UIPortfolio
{
    ...
    public class MenuSettings : ScriptableObject
    {
        ...
        private string[,]  MainContentItems = new string[12, 6] {
                ...
                { "Textures/icons/inventory", "Textures/Images/image3", "Inventory System", "inventory", "Textures/icons/inventory" ,
                    "The <b>Inventory System</b> allows players to manage and organize the items they collect during their adventure." },
                { "Textures/icons/dialogue", "Textures/Images/image4", "Dialogue System", "dialogue", "Textures/icons/dialogue" ,
                    "The <b>Dialogue System</b> facilitates interactions between characters, helping to drive the game's story forward." },
                { "Textures/icons/in-game-shop", "Textures/Images/image5", "In-Game Shop", "in-game-shop", "Textures/icons/in-game-shop" ,
                    "The <b>In-game Shop</b> offers players a place to purchase items, upgrades, or abilities using in-game currency." },
                { "Textures/icons/settings", "Textures/Images/image6", "Settings Menu", "settings", "Textures/icons/settings" ,
                ...
                { "Textures/icons/loading-screen", "Textures/Images/image7", "Loading Screen", "loading-screen", "Textures/icons/loading-screen" ,
                    "The <b>Loading Screen</b> provides players with helpful tips or game lore while new game assets are being loaded." },
                { "Textures/icons/achievement", "Textures/Images/image8", "Achievement System", "achievement", "Textures/icons/achievement" ,
                    "The <b>Achievement System</b> rewards players for completing specific challenges or milestones within the game." },
                { "Textures/icons/pause-menu", "Textures/Images/image9", "Pause Menu", "pause-menu", "Textures/icons/pause-menu" ,
                    "The <b>Pause Menu</b> allows players to temporarily stop the game, access settings, or save their progress." },
                { "Textures/icons/tutorial", "Textures/Images/image10", "Tutorial Overlay", "tutorial", "Textures/icons/tutorial" ,
                    "The <b>Tutorial Overlay</b> guides new players through the game's mechanics and controls, ensuring a smooth learning curve." },
                { "Textures/icons/unity-articles", "Textures/Images/image11", "Unity Articles", "articles", "Textures/icons/unity-articles" ,
                    "" },
        ...
        private string[,] ContactContentItems = new string[8, 7] {
            ...
            { "-", "Textures/Icons/hud", "<b>Email</b>\n<a href='mailto:lemapp.yahoo.com>lemapp@yahoo.com'>lemapp.yahoo.com>lemapp@yahoo.com</a>", "", "Textures/icons/hud",
                "<b>Email</b>", "mailto:lemapp.yahoo.com" },
            { "-", "Textures/Icons/main-menu", "<b>LinkedIn Profile</b>\nhttps://www.linkedin.com/\nin/lem-apperson-b9733b50/", "",
                "Textures/icons/inventory",
